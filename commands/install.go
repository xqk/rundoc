...
func initialization() {
	...
	if errors.Is(err, orm.ErrNoRows) {
		...
		book.BookName = i18n.Tr(lang, "init.default_proj_name") //"RunDoc演示项目"
		book.Status = 0
		book.ItemId = 1
		book.Description = i18n.Tr(lang, "init.default_proj_desc") //"这是一个RunDoc演示项目，该项目是由系统初始化时自动创建。"
		book.CommentCount = 0
		book.PrivatelyOwned = 0
		book.CommentStatus = "closed"
		book.Identify = "rundoc"
		book.DocCount = 0
		book.CommentCount = 0
