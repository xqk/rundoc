...
import (
	...
	"github.com/xqk/rundoc/cache"
	"github.com/xqk/rundoc/conf"
	"github.com/xqk/rundoc/models"
...
func ResolveCommand(args []string) {
	flagSet := flag.NewFlagSet("RunDoc command: ", flag.ExitOnError)
	flagSet.StringVar(&conf.ConfigurationFile, "config", "", "RunDoc configuration file.")
	flagSet.StringVar(&conf.WorkingDirectory, "dir", "", "RunDoc working directory.")
	flagSet.StringVar(&conf.LogFile, "log", "", "RunDoc log file path.")
