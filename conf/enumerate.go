...
// 用户权限
const (
	// MemberSuperRole 超级管理员.
	MemberSuperRole SystemRole = iota
	// MemberAdminRole 普通管理员.
	MemberAdminRole
	// MemberGeneralRole 普通用户.
	MemberGeneralRole
)
...
const (
	// AuthMethodLocal 本地账户校验
	AuthMethodLocal = "local"
	// AuthMethodLDAP LDAP用户校验
	AuthMethodLDAP = "ldap"
)
...
func GetAppKey() string {
	return web.AppConfig.DefaultString("app_key", "rundoc")
}
...
// GetUploadFileSize 获取上传文件允许的最大值
...
// GetExportQueueLimitNum 等待导出队列的长度
...
// GetExportOutputPath 默认导出项目的缓存目录
