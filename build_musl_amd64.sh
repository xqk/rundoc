rm rundoc_linux_musl_amd64 rundoc_linux_amd64
rm -rf ../rundoc_linux_musl_amd64/
...
mkdir ../rundoc_linux_musl_amd64
cp -r * ../rundoc_linux_musl_amd64
cd ../rundoc_linux_musl_amd64
...
zip -r rundoc_linux_musl_amd64.zip conf static uploads views lib rundoc_linux_musl_amd64 LICENSE.md
mv ./rundoc_linux_musl_amd64.zip ../
