...
<head>
    ...
    <title>{{i18n .Lang "project.prj_space_list_of" .Model.ItemName}} - Powered by RunDoc</title>
    <meta name="keywords" content="RunDoc,文档在线管理系统,WIKI,wiki,wiki在线,文档在线管理,接口文档在线管理,接口文档管理,{{.Model.ItemName}}">
