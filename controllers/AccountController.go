...
import (
	...
	"github.com/xqk/rundoc/utils/auth2"
	"github.com/xqk/rundoc/utils/auth2/dingtalk"
	"github.com/xqk/rundoc/utils/auth2/wecom"
	"html/template"
	"math/rand"
	"net/http"
	"net/url"
...
//	if len(req_code) > 0 && req_state == "rundoc" {
//		// 获取当前应用的access_token
