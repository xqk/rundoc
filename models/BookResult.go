...
import (
	...
	"github.com/xqk/rundoc/converter"
	"github.com/xqk/rundoc/utils/cryptil"
	"github.com/xqk/rundoc/utils/filetil"
	"github.com/xqk/rundoc/utils/gopool"
	"github.com/xqk/rundoc/utils/requests"
	"github.com/xqk/rundoc/utils/ziptil"
)
...
func (m *BookResult) Converter(sessionId string) (ConvertBookResult, error) {
	...
	ebookConfig := converter.Config{
		...
		Footer:       "<p style='color:#8E8E8E;font-size:12px;'>本文档使用 <a href='https://www.iminho.me' style='text-decoration:none;color:#1abc9c;font-weight:bold;'>RunDoc</a> 构建 <span style='float:right'>- _PAGENUM_ -</span></p>",
